...
$buscar = $_GET['id'];
  ...
  $querySelect = "SELECT rut FROM personas where id = ".$buscar;
  ...
  $queryDelete = 'DELETE FROM personas WHERE id = "'.$buscar.'"';

  $retry_value = mysqli_query($conn,$queryDelete);

  if($retry_value){
          date_default_timezone_set("America/Santiago");
          $fecha = date('Y-m-d H:i:s');
          $queryInsertb = "INSERT INTO bitacora (usuario, accion, descripcion, fecha) VALUES ('".$_SESSION["usuario"]."','eliminar','".$rut."','".$fecha."')";
